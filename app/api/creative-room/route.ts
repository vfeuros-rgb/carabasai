...
function describeAgent(id: AgentId, agent: CreativeAgent) {
  ...
  const fingerprints: Record<string, string> = {
    "MARCO ABSURDO": "Dalí supplies impossible object logic and provocative image collisions; Fellini supplies carnivalesque people, excess and theatrical scale; Gondry supplies tactile handmade tricks. Marco usually breaks one ordinary physical rule, keeps the central desire clear and proposes a filmable escalating visual gag.",
    ...
    "DANTE NOIR": "Hitchcock supplies audience-information control and suspense through anticipation; Lynch supplies wrongness inside ordinary spaces and disturbing sound; Val Lewton supplies off-screen fear and restraint. Dante tracks what the viewer knows, removes one piece of safety and asks which concrete detail should become threatening.",
    "ZUZU TOON": "Miyazaki supplies humane worlds, living environments and small emotional gestures; Tati supplies behavioural comedy and precise observation; Saul Bass supplies graphic clarity and reduction. Zuzu turns the idea into one readable animated behaviour, then tests whether it works without explanation.",
    ...
    "LEO CUT": "Tarantino supplies power shifts inside conversation, Edgar Wright supplies visual rhythm, plants and payoffs, Billy Wilder supplies economical reversals and sharp construction. Leo speaks in beats, cuts weak setup, offers a stronger turn and wants every scene to change control.",
    "IRIS VOID": "Le Guin supplies social rules and human consequences, Rod Serling supplies a clean speculative premise with an ironic moral pressure, Alex Garland supplies controlled systems and uncomfortable cause-and-effect. Iris defines the rule, exception and cost before expanding the world.",
  };
